				...
				<!--form-stars-here-->
						<div class="form-w3-agile">
							...
							<form action="codeindex.php" method="post">
								...
								<p class="p-bottom-w3ls">Đổi mật khẩu?<a class href="formdmk.php"> Click vào </a></p>
								<p class="p-bottom-w3ls1">Đăng ký tài khoản?<a class href="formdangky.php"> Đăng ký </a></p>
								<div class="clear"></div>
